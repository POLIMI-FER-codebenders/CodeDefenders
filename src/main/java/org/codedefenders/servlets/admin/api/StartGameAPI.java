...
public class StartGameAPI extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (game == null) {
            ...
            Utils.respondJsonError(response, "Only the game's creator can start the game", HttpServletResponse.SC_BAD_REQUEST);
        } else if (game.getState() != GameState.CREATED) {
            Utils.respondJsonError(response, "Game cannot be started since it has state " + game.getState(), HttpServletResponse.SC_BAD_REQUEST);
        } else {
