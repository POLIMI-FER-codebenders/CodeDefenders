...
@Singleton
public class CodeDefendersAPIBearerHttpAuthenticatingRealm extends CodeDefendersBearerHttpAuthenticatingRealm {
    @Inject
    public CodeDefendersAPIBearerHttpAuthenticatingRealm(CodeDefendersRealm.CodeDefendersCacheManager codeDefendersCacheManager,
        ...
        setAuthenticationTokenClass(APIBearerToken.class);
    }

    public Account checkToken(String token) {
        Optional<UserEntity> activeUser = userRepo.getUserByApiToken(token);
